...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#" xmlns:fb="https://www.facebook.com/2008/fbml">
	<head>
		<title><?php echo $cfg['game_name']; ?> - gra online</title>

		<meta id="og_title" property="og:title" content="<?php echo $cfg['game_name']; ?>"/>
		<meta id="og_type" property="og:type" content="game"/>
		<meta id="og_url" property="og:url" content="<?php echo $cfg['host']; ?>/index.php"/>
		<meta id="og_image" property="og:image" content="http://www.die-staemme.de/graphic/reports/support_arrives.jpg"/>
		<meta id="og_site_name" property="og:site_name" content="<?php echo $cfg['game_name']; ?>"/>
		<meta id="fb_app_id" property="fb:app_id" content="110344252415324"/>

		<link rel="canonical" href="<?php echo $cfg['host']; ?>/" />

					<meta id="og_description" property="og:description" content="<?php echo $cfg['game_name']; ?> - gra online"/>
		
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<meta name="description" content="<?php echo $cfg['game_name']; ?> to przeglądarkowa gra online. Każdy gracz posiada małą wioskę, którą ma doprowadzić do władzy i chwały." />
		...
		<link rel="stylesheet" type="text/css" href="/merged/index.css?1415697140" />

		<script type="text/javascript" src="/merged/index.js?1415697140"></script>

						<link rel="alternate" type="application/rss+xml" title="<?php echo $cfg['game_name']; ?> - Nowości" href="<?php echo $cfg['host']; ?>/news.php?type=rss2.0" />
				...
				<a href="http://www.innogames.com?ref=ds_portalbar_innogames" target="_blank" title="Przejdź do innogames.com"><span>Innogames.com</span></a>
					...
					<div class="pb-lang-sec-options">
						<ul>
							<?php
							/* Servers ad: */
							/* DO NOT DELETE OR EDIT THIS CODE */
							/* NIE USUWAĆ ANI EDYTOWAĆ PONIŻSZEGO KODU */
							/*$open = MyTW_ads_load("portalbar_servers");
							if ($open===false) {
								echo "<li>Nie udało się załadować listy!</li>";
							} else {
								echo $open;
							}*/
							?>
					...
					<div class="pb-moregames-overview-lists">
						...
						<ul class="pb-moregames-overview clear">
							<li class="pb_game_thumb pb_game_staemme">
								<a href="http://www.plemiona.pl?ref=twx_portalbar_moregames" target="_blank"><img src="https://portal-bar.innogamescdn.com/images/thumbs/staemme-558x106.jpg" title="Plemiona"  width="558" height="106"></a>
										<a href="http://www.plemiona.pl" title="Plemiona" target="_blank">
							...
							<li class="pb_game_thumb pb_game_tribalwars2">
																				...
																				<a href="https://pl.tribalwars2.com?ref=ds_portalbar_moregames" target="_blank"><img src="http://portal-bar.innogamescdn.com/images/thumbs/tribalwars2-180x106.jpg" title="Tribal Wars 2" height="106" width="180"></a>
									...
									</li>																																<li class="pb_game_thumb pb_game_foe">
										...
										<a href="http://www.the-west.pl?ref=ds_portalbar_moregames" title="The West" target="_blank">
											<div class="pb-caption">
												...
												<p>Odkryj dziewicze terytoria, przeżyj pasjonujące przygody i pojedynkuj się z innymi graczami. The West czeka na ciebie!</p>
																				...
																				<a href="https://pl.risinggenerals.com?ref=ds_portalbar_moregames" target="_blank"><img
											src="http://portal-bar.innogamescdn.com/images/thumbs/nova-180x106.jpg"
											title="Rising Generals" width="180" height="106"/></a>
										<a href="https://pl.risinggenerals.com?ref=ds_portalbar_moregames" title="Rising Generals" target="_blank">
											<div class="pb-caption">
									...
									<a href="http://www.innogames.com/pl/mobile?ref=ds_portalbar_innogames" target="_blank"><img
										src="http://portal-bar.innogamescdn.com/images/thumbs/mobile-180x106.jpg"
...
<div class="pb-tab"></div>
		...
		<div id="index_body">
			<div id="main">
						<div id="header">
				<h1 class="title">					<a href="/" style="background:url(<?php echo $cfg['cdn']; ?>/graphic/lang/pl/bg-logo.jpg?dcee3) no-repeat 100% 0;">
						<p style="position: absolute; top: -300px"><?php echo $cfg['game_name']; ?> - gra online</p>
					</a>
				</h1>				<div class="navigation">
					<div class="navigation-holder">
						<div class="navigation-wrapper">
							<div id="navigation_span">
								<a href="<?php echo $cfg['host']; ?>/dotations.php" >Dotacje</a>
																		<span class="sep">-</span>
																										<a href="<?php echo $cfg['host']; ?>/register.php" >Rejestracja</a>
																		<span class="sep">-</span>
																										<a href="<?php echo $cfg['host']; ?>/rules.php" >Zasady</a>
																		<span class="sep">-</span>
																										<a href="/stat.php" >Statystyki</a>
																		<span class="sep">-</span>
																										<a href="<?php echo $cfg['host']; ?>/sds_rounds.php" >Szybkie</a>
																		<span class="sep">-</span>
																										<a href="#" target="_blank">Pomoc</a>
																		<span class="sep">-</span>
																										<a href="/ticket.php" target="_blank">Support</a>
																		<span class="sep">-</span>
				...
				<?php if ($no_paladin!==true) {?><span class="paladin"><img src="<?php echo $cfg['cdn']; ?>/graphic/index/bg-paladin-new.png?33a83" alt="" /></span><?php } ?>			</div>